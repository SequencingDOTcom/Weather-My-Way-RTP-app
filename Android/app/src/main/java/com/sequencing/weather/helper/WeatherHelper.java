...
public class WeatherHelper {
    ...
    public static Map<String, String> getCityIdByGeoData(double latitude, double longitude) throws WUndergroundException, JsonSyntaxException {
        String cityId = null;
    ...
    private static void checkWeatherUndergroundResponse(String response) throws WUndergroundException {
        ...
        try{
            mainObject = gson.fromJson(response, JsonObject.class);
        }catch (JsonSyntaxException e){
            throw new JsonSyntaxException("Unable to get response from wunderground.com");
        }
