...
//        return CONTENT_URI + getRandomVideo();
//        return SHUTTERSTOCK_V4584485;
        ...
        if(weather == null)
            ...
            return CONTENT_URI + WEATHER_CONDITION_DAY.get(weather.toLowerCase());
        else
            return CONTENT_URI + WEATHER_CONDITION_NIGHT.get(weather.toLowerCase());
    }
