...
namespace Sequencing.WeatherApp.Controllers.DaoLayer
{
    ...
    {
        void Subscribe(string deviceToken, DeviceType deviceType, string accessToken, ApplicationType? appType, string appVersion);
        ...
        void SubscribeDeviceToken(string token, DeviceType deviceType, long userId, ApplicationType? appType, string appVersion);
